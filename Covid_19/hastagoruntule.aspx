<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hastagoruntule.aspx.cs" Inherits="Covid_19.hastagoruntule" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-color:blueviolet ; width:auto;height:900px ">
            <h1 style="text-align:center ;font-size:30px ">Hastaları Görüntüle</h1>
        <div>
