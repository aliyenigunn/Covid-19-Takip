<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hastakayit.aspx.cs" Inherits="Covid_19.hastakayit" %>
...
<body>
    <form id="form1" runat="server" >
        <div style="background-color:blueviolet ; width:auto;height:900px ">
            <h1 style="text-align:center ;font-size:30px ">Hasta Kayıt Ekleme </h1>
                ...
                <table class="ortala" style="width: 100%;">
                   ...
                   <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="auto-style1" >HASTA DURUMU</td>
                        <td class="tablo"> : </td>
                        <td><asp:DropDownList ID="cbdurum" runat="server" Height="25px" Width="405px">
                            <asp:ListItem>SEÇİNİZ</asp:ListItem>
                            <asp:ListItem>AYAKTA</asp:ListItem>
                            <asp:ListItem>AĞIR</asp:ListItem>
                            <asp:ListItem>KRİTİK</asp:ListItem>
                            </asp:DropDownList></td>
                    </tr>     
